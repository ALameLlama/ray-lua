...
build = {
	...
	modules = {
		...
		["ray.concerns.colors"] = "src/concerns/colors.lua",
		["ray.concerns.screen_colors"] = "src/concerns/screen_colors.lua",
		["ray.concerns.sizes"] = "src/concerns/sizes.lua",
		...
		["ray.test.class.client"] = "tests/class/client.lua",
